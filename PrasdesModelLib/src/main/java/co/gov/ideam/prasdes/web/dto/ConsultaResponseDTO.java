...
@JsonPropertyOrder({ "N_IDSTATION", "N_IDVAR", "D_DATADATE", "N_IDSOURCE", "N_DATA", "N_IDQC", "N_IDFLAG", "N_IDUSER", "D_DATEADD" })
@JsonIgnoreProperties(ignoreUnknown = true)
public class ConsultaResponseDTO {
	
	
	
	public ConsultaResponseDTO(long nIdstation, long nIdvar, Date dDatadate, long nIdsource, BigDecimal nData,
...
//	}
	...
	public void setsdDatadate(String fechastr) {				
		this.dDatadate = (StringUtils.isEmpty(fechastr) ? null : Utilidades.parsearFechaNoThrow(fechastr));
	}
...
//	}
	...
	public String getdDateaddByIndex() {		
		return (dDateadd!=null ? Utilidades.formatearFecha(dDateadd) : null) ;
	}
	
	@JsonGetter("D_DATEADD")
	public String getdDateaddString() {		
		return (dDateadd!=null ? Utilidades.formatearFecha(dDateadd) : null) ;
	}
