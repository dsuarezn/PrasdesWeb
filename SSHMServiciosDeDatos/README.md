...
* In `jboss-as-spring-mvc-context.xml` `<context:component-scan base-package="co.gov.ideam.prasdes.intersync.controller"/>` and `<mvc:annotation-driven/>` are used to register both the non-rest and rest controllers.
...
4. This will deploy `target/intersync.war` to the running instance of the server.


Access the application
----------------------

The application will be running at the following URL: <http://localhost:8080/intersync/>.
